...
let card = confirm("Do you hava any discount card?")
...
if (card == true) {
    ...
    const customer = new Customer(name, surname, card, product)

    console.log("Amount to be paid " + customer.calculateDiscount());

} else {
    const customer2 = new Customer(null, null, card, product)
    console.log(customer2.calculateDiscount());
}
...
//--------------------------------------------------------------------------
// Bu ferqli formada ozum yazdigim idi
